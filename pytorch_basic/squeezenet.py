...
实现说明:
https://tech.foxrelax.com/ml/lightweight/squeezenet/
"""


def load_weight(version='1.0', cache_dir='../data'):
    """
...
class SqueezeNet(nn.Module):
    def __init__(self, version="1_0", num_classes=1000, dropout=0.5) -> None:
        super().__init__()
...
def squeezenet(pretrained=True, num_classes=5, version='1.0', dropout=0.5):
